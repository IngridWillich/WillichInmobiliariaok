...
class _VentaPageState extends State<VentaPage> {
  ...
  Future<List<dynamic>> _fetchVentas() async {
    final allProperties = await PropertyService.fetchProperties();
    return allProperties
        .where((prop) =>
            prop['tipo']?.toString().toLowerCase().trim() == 'venta')
        .toList();
  }
  ...
  void _launchWhatsApp() async {
    final whatsappUrl = "https://wa.me/5493434662544?text=Hola,%20estoy%20interesado%20en%20una%20propiedad%20en%20venta";
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        child: const Text('Consultar propiedades'),
                      ),
                    ],
                  ),
                ),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    Text(
                      'Explora nuestra selección exclusiva de propiedades en venta',
                      style: TextStyle(
                        fontSize: 16,
                            ...
                            children: [
                              Container(
                                ...
                                child: Column(
                                  mainAxisSize: MainAxisSize.min,
                                  children: [
                                    Icon(Icons.home, size: 48, color: Colors.grey.shade400),
                                    const SizedBox(height: 16),
                                    const Text(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 24),
                    Text(
                      'Contáctenos para programar una visita o recibir más información sobre nuestras propiedades disponibles.',
                      style: TextStyle(
